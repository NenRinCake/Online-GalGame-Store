...
<head>
    ...
    <script>
        ...
        window.onload = function() {
            ...
            var mm = '<%= request.getAttribute("mm") %>';
            if (mm && mm.trim() !== '' && mm.trim() !== 'null') {
                alert(mm);
            }
...
<div class="search-bar">
    <form action="GoodSearchServlet" method="post">
        <input type="text" class="search-input" name="search-input" placeholder="在这里输入您想要的商品...">
...
<%
    ...
    Goods[] goods = null;
    try{
        goods = GoodsServlet.retrieveGoods();
...
<script>
    function showDiscountTag() {
        var discountTag = document.getElementById('discountTag');
        if (discountTag) {
